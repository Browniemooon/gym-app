  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-black uppercase italic tracking-tight">Gym Management</h2>
        <div className="flex gap-2">
          <Button variant="danger" onClick={handleCleanupUsers} icon={Trash2} loading={isSaving}>Cleanup Users</Button>
          <Button variant="primary" onClick={() => setIsAdding(true)} icon={Plus}>Add New Gym</Button>
        </div>
      </div>
          ...
          <div className="space-y-4 pt-4 border-t border-white/5">
           <h4 className="text-[10px] font-black uppercase italic tracking-[0.2em] text-[var(--primary)]">Gym Customization</h4>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)]">Logo URL</label>
                <input
                  type="text"
                  placeholder="https://..."
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:neon-border outline-none"
